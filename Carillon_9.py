# C A R I L L O N 
# Sur une idée de J-P Perroud
# Création le 01-08-2024
# Mise à jour le 31-08-2024 / 08-11-2024 / 19-11-2024
# Import mido et pygame a installer avec pip
# dans le terminal pip install mido pygame
# -----------------------------------------------------
...
def plain_bob_permutation(notes):
    ...
    while True:
        ...
        new = current.copy()
        if new == notes:  # Full cycle completed
            break
        result.append(new)
...
def generate_random_notes(num_bells):
    return random.sample(list(note_to_midi.values()), num_bells)
...
if __name__ == "__main__":
    print("Lancement de l'application Carillon")
    app = CarillonApp()
    app.mainloop()
    print("Fin de l'application Carillon")
